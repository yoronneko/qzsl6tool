...
File Path : 20260912-034300.sbas
Date Time : 2026-09-12 03:43:00 UTC
Duration  : 14 minutes
...
Duration  : 5 messages
Note      : SYNTHETIC SBAS authentication messages (MT20, MT21), NOT a real broadcast
Note      : hand-made bit patterns following the draft ICAO SARPs formats
Note      : generated by sample/make_synthetic_sbas_auth.py

File Path : synthetic-dcx.l1s
Date Time : (none, SYNTHETIC data)
Duration  : 10 messages
Note      : SYNTHETIC QZSS DCX messages (L1S MT44), NOT a real broadcast
Note      : hand-made bit patterns following IS-QZSS-DCX-004, using the
Note      : calculation examples in the specification where available
Note      : generated by sample/make_synthetic_dcx.py
