...
class Color:
    ...
    def __init__(self, fp=sys.stdout, is_forced=False):
        if is_forced: self.fp = fp
        else        : self.fp = None if not fp or not fp.isatty() else fp
    ...
    def fg(self, color='default'):  # foreground color
        ...
        result = ''
        if   color == "black"  : result += "\x1b[30m"
        elif color == "red"    : result += "\x1b[31m"
        elif color == "green"  : result += "\x1b[32m"
        elif color == "yellow" : result += "\x1b[33m"
        elif color == "blue"   : result += "\x1b[34m"
        elif color == "magenta": result += "\x1b[35m"
        elif color == "cyan"   : result += "\x1b[36m"
        elif color == "white"  : result += "\x1b[37m"
        elif color == "default": result += "\x1b[39m"
        else:
    ...
    def bg(self, color='default'):  # background color
        ...
        if not self.fp: return ''
        result = ''
        if   color == "black"  : result += "\x1b[40m"
        elif color == "red"    : result += "\x1b[41m"
        elif color == "green"  : result += "\x1b[42m"
        elif color == "yellow" : result += "\x1b[43m"
        elif color == "blue"   : result += "\x1b[44m"
        elif color == "magenta": result += "\x1b[45m"
        elif color == "cyan"   : result += "\x1b[46m"
        elif color == "gray"   : result += "\x1b[47m"
        elif color == "default": result += "\x1b[49m"
        else:
    ...
    def dec(self, style='default'):  # text decoration
        ...
        if not self.fp: return ''
        result = ''
        if   style == "default"  : result += "\x1b[0m"
        elif style == "bold"     : result += "\x1b[1m"
        elif style == "dark"     : result += "\x1b[2m"
        elif style == "italic"   : result += "\x1b[3m"
        elif style == "underline": result += "\x1b[4m"
        elif style == "blink"    : result += "\x1b[5m"
        elif style == "hblink"   : result += "\x1b[6m"
        elif style == "reverse"  : result += "\x1b[7m"
        elif style == "hide"     : result += "\x1b[8m"
        elif style == "strike"   : result += "\x1b[9m"
        else:
